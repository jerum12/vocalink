...
(function ($, doc, win, Snap) {
   ...
   ***********************************************************/
  Donut.prototype.animateArcByStroke = function (
    arc,
    strokeWidthStart,
    strokeWidthEnd,
    duration,
   ...
   ***********************************************************/
  Donut.prototype.startShowAnimationOneEntry = function (
    d,
    percentStart,
    percentEnd,
    center,
...
var donut2 = $('#svg2').donut({
  ...
  radius: (donutSize * 0.3) / 1,
  data: transactionListSavings,
});

donut2.startShowAnimation(function () {
  $('button').attr('disabled', false);
});

var donut3 = $('#svg3').donut({
  donutSize: donutSize,
  center: {
    x: donutSize / 2,
    y: donutSize / 2,
  ...
  radius: (donutSize * 0.3) / 1,
  data: transactionListLICC,
});

donut3.startShowAnimation(function () {
  $('button').attr('disabled', false);
});

var donut4 = $('#svg4').donut({
  donutSize: donutSize,
  center: {
    x: donutSize / 2,
    y: donutSize / 2,
  ...
  radius: (donutSize * 0.3) / 1,
  data: transactionListLPC,
});

donut4.startShowAnimation(function () {
  $('button').attr('disabled', false);
});
